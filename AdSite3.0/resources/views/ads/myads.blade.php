                        ...
                        @foreach($yourads as $colectieads)
                            <div class="w3-panel w3-pale-green">
                                ...
                                <a class="btn btn-sm btn-outline-success py-0 openEditModal"
                                   data-edit="{{json_encode($colectieads->edit_data)}}">Edit</a>
                                <a href="{{route('ads.destroy',$colectieads->id)}}"
                                   class="btn btn-sm btn-outline-danger py-0 deleteAd" data-id="{{$colectieads->id}}">Delete</a>
                            </div>
                        @endforeach
                    </div>
                </div>
