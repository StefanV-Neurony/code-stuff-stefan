                        ...
                        @foreach($ads as $colectieads)
                         <br>   <div class="card" style="width: 18rem;">
                                ...
                                @if($colectieads->user->name!=$currentuser->name)
                                        ...
                                        <button class="press press-green press-pill press-ghost purchaseAd" data-user="{{json_encode($currentuser)}}" data-edit="{{json_encode($colectieads->edit_data)}}">Purchase item</button>
                                @endif
                                            @endauth
                                </div>
                            </div>
